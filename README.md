<!--
  halittosun38 GitHub profil README
  Kurulum:
   1) github.com/new -> repo adi: halittosun38 (kullanici adinla AYNI), Public, Add a README
   2) Bu dosyanin TAMAMINI README.md icine yapistir, commit et.
-->
...
@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@=:::    -----------------------------------------
***************##########%%%%###%%%%%%%%%#%%*#%%####-:::    OS: .............. Windows, Linux
::::::::::::::::--------=====---===========-==----=-::::    Host: ............ Tosun Development
@@%%@@@@@@@@@@@@@%-------------===========-----::-=-:.::    Uptime: .......... 22 years
@@@@@@@@@@@@@@@@@@=:------------------------:::::==-:.:.    IDE: ............. VS Code
@@@@@@@@@@@@@@@@@@-:-:::-------------------::::::==-::::    Shell: ........... zsh, powershell
@@@@@@@@@@@@@@@@@@-:::::----------------------:::===::::
#%%%%%@%@@@@@@@@@@=:---------==========++++===---++=::::    - Languages -----------------------------
**#%%%%***#@@@@@@@+------====++*****+++*####*+=--**+::::    Programming: ..... Python, Lua, JavaScript, C#
+*****%#**%@@@@@@@+==++++***#%%%@@%%####%@@%%*+==**+::::    Markup & Style: .. HTML, CSS
++=*==#%*#%%@@@@@@=--===+**%@@@@@@@@@@@@@@@@@@%#*%%#---:    Real: ............ Turkce, English
+*+++++*+#*=@@@@@@=:-----=+*#%@@@@@@@@@@@@@@@@@%%@%%*+++
-++=++++-*+=@@@@@@=::::-=+***##%@@@@%%%@@@@%%#*++##*===-    - Projects ------------------------------
 +=..==++*+-@@@@@@-..:=*###***+==+%%%%######*+=--++=::::    Tosun Anticheat:   FiveM anticheat & panel
:=-=:=++*++*@@@@@@:.:+**=-:.::....===*===++=++=::++=::::    Website: ......... tosundev.com
*=::.-:+*+==@@@@@@: ::-=-:-::--==-..--------**+--%%*....
+++-:==***++@@@@@@: ::*##**++*****=.:--::-::+#+-:**+ .      - Contact -------------------------------
--:. .=*++**@@@@@@: -+#+===++=---+*=-::::::.+#=..--=.-:.    YouTube: ......... @Tosun0038
######%%%%%%@@@@@@: *#*=:.:++-..:=***::::::.-=-..--- ..     Discord: ......... discord.gg/tosun
@@@@@@@@@@@@@@@@@@. -%#**++#**+++*#*+.:......    ::. . :    Store: ........... tosun.tebex.io
@@@@@@@@@@@@@@@@@@:  +##**+++==+***=:.........   ......=
-:::::-=----==----. ..+#*-:::.::=+=.             ...  .-    - GitHub Stats --------------------------
:::..    ..  .       . -*+++:-=+=:=-:.    .:...  ......-    Repos: 5   |   Followers: 1
*****++-..::...      .:-+=-:..:::-=:.=*=. ..:..   ..---=
